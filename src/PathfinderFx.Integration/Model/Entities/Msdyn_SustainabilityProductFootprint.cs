...
namespace PathfinderFx.Integration.Model.Entities
{
	...
	public enum Msdyn_SustainabilityProductFootprint_Msdyn_FootprintStatus
	{
		...
		[OptionSetMetadata("Active", 0, "#0000ff")]
		Active = 700610000,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		[OptionSetMetadata("Inactive", 1, "#0000ff")]
		Inactive = 700610001,
	}
	...
	public partial class Msdyn_SustainabilityProductFootprint : Microsoft.Xrm.Sdk.Entity
	{
		...
		public Msdyn_SustainabilityProductFootprint(System.Guid id) : 
		...
		public Microsoft.Xrm.Sdk.EntityReference Msdyn_Company
		{
			...
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("msdyn_company");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("msdyn_company", value);
			}
		}
		...
		public string Msdyn_CompanyName
		{
			...
			get
			{
				if (this.FormattedValues.Contains("msdyn_company"))
				{
					return this.FormattedValues["msdyn_company"];
				}
				else
				{
					return default(string);
		...
		public virtual Msdyn_SustainabilityProductFootprint_Msdyn_FootprintStatus? Msdyn_FootprintStatus
		{
			...
			set
			{
				this.SetAttributeValue("msdyn_footprintstatus", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		...
		public string Msdyn_FootprintStatusName
		{
			...
			get
			{
				if (this.FormattedValues.Contains("msdyn_footprintstatus"))
				{
					return this.FormattedValues["msdyn_footprintstatus"];
				}
				else
				{
					return default(string);
		...
		public string Msdyn_SpecVersion
		{
			...
			get
			{
				return this.GetAttributeValue<string>("msdyn_specversion");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("msdyn_specversion", value);
			}
		}
		...
		public string Msdyn_StatusComment
		{
			...
			get
			{
				return this.GetAttributeValue<string>("msdyn_statuscomment");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("msdyn_statuscomment", value);
			}
		}
		...
		public Microsoft.Xrm.Sdk.EntityReference Msdyn_SustainabilityProduct
		{
			...
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("msdyn_sustainabilityproduct");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("msdyn_sustainabilityproduct", value);
			}
		}
		...
		public Microsoft.Xrm.Sdk.EntityReference Msdyn_SustainabilityProductCarbonFootprint
		{
			...
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("msdyn_sustainabilityproductcarbonfootprint");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("msdyn_sustainabilityproductcarbonfootprint", value);
			}
		}
		...
		public string Msdyn_SustainabilityProductCarbonFootprintName
		{
			...
			get
			{
				if (this.FormattedValues.Contains("msdyn_sustainabilityproductcarbonfootprint"))
				{
					return this.FormattedValues["msdyn_sustainabilityproductcarbonfootprint"];
				}
				else
				{
					return default(string);
		...
		public System.Nullable<System.Guid> Msdyn_SustainabilityProductFootprintId
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<System.Guid>>("msdyn_sustainabilityproductfootprintid");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("msdyn_sustainabilityproductfootprintid", value);
				if (value.HasValue)
				{
					base.Id = value.Value;
				}
		...
		public override System.Guid Id
		{
			...
			set
			{
				this.Msdyn_SustainabilityProductFootprintId = value;
			}
		}
		...
		public string Msdyn_SustainabilityProductName
		{
			...
			get
			{
				if (this.FormattedValues.Contains("msdyn_sustainabilityproduct"))
				{
					return this.FormattedValues["msdyn_sustainabilityproduct"];
				}
				else
				{
					return default(string);
		...
		public System.Nullable<System.DateTime> Msdyn_ValidityPeriodEnd
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("msdyn_validityperiodend");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("msdyn_validityperiodend", value);
			}
		}
		...
		public System.Nullable<System.DateTime> Msdyn_ValidityPeriodStart
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("msdyn_validityperiodstart");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("msdyn_validityperiodstart", value);
			}
		}
		...
		public Msdyn_SustainabilityProductCarbonFootprint Msdyn_Msdyn_SustainabilityProductFootprint_SuSt
		{
			...
			get
			{
				return this.GetRelatedEntity<Msdyn_SustainabilityProductCarbonFootprint>("msdyn_msdyn_sustainabilityproductfootprint_sust", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<Msdyn_SustainabilityProductCarbonFootprint>("msdyn_msdyn_sustainabilityproductfootprint_sust", null, value);
			}
		}
